...
const ResetPassword = () => {
  ...
  // this below function is used to clear the otp and shift the focus just previous cell
  ...
  // this below function is used for copy and paste the otp
  const handlePaste = (e) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      />
      {/* email id for resetting the password */}
